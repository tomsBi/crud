                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           value="{{ $employee->name }}" autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text"
                                           ...
                                           value="{{ $employee->surname }}" autocomplete="surname" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text"
                                           ...
                                           value="{{ $employee->text_comment }}" autocomplete="text_comment" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control @error('date_of_birth') is-invalid @enderror" type="date"
                                           ...
                                           id="date_of_birth" value="{{ $employee->date_of_birth }}" autofocus>
                                    @error('date_of_birth')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
